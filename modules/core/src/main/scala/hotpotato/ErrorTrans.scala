...
object ErrorTrans extends LowerPriorityErrorTrans {
  ...
  implicit def eitherTErrorTrans[G[_]: Functor, E, A]
    : ErrorTrans[EitherT[G, *, *], E, A] =
  ...
  implicit class ErrorTransCoprodEmbedOps[F[_, _], L <: Coproduct, R](
    ...
    def embedError[Super <: Coproduct](implicit F: ErrorTrans[F, L, R],
  ...
  implicit class ErrorTransIdLeftOps[F[_, _], L, R](val in: F[L, R])
      extends AnyVal {
  ...
  implicit class ErrorTransOps[F[_, _], L <: Coproduct, R](val in: F[L, R])
    ...
    def handleSome[L0,
                   ...
                   L1Out,
                   BasisRest <: Coproduct,
                   UniqueOut <: Coproduct](func0: L0 => L0Out,
                                           func1: L1 => L1Out,
    ...
    def handleSome[L0,
      ...
      unique: Unique.Aux[L0Out :+: L1Out :+: L2Out :+: L3Out :+: BasisRest,
                         UniqueOut],
      errorTrans: ErrorTrans[F, L, R],
    ): F[UniqueOut, R] = {
      errorTrans.transformError(in) { err =>
    ...
    def handle[L0,
               ...
               Out,
               BasisRest <: Coproduct,
               UniqueOut <: Coproduct](func0: L0 => Out,
                                       func1: L1 => Out,
                                       func2: L2 => Out,
                                       func3: L3 => Out)(
...
trait LowerPriorityErrorTrans {
  implicit class ErrorTransEmbedOps[F[_, _], ThisError, T](
    ...
    def handleSomeAdt[L0,
      ...
      F: ErrorTrans[F, ThisError, T],
      gen: Generic.Aux[ThisError, Co],
      basisRemoveFromAdt: Basis.Aux[Co,
                                    L0 :+: L1 :+: L2 :+: L3 :+: CNil,
                                    PartialCo],
